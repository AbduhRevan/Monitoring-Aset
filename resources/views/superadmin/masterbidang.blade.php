...
<head>
    ...
    <title>Data Master Bidang - SIMASTER</title>
...
<body>
        ...
        <div class="content-area">
            ...
            <div class="content-card">
                <div class="card-header-custom">
                    <h6><i class="bi bi-building"></i> Daftar Bidang</h6>
                ...
                <div class="card-body-custom">
                    ...
                    <div class="search-wrapper">
                        <input type="text" class="search-input" placeholder="Cari bidang..." id="searchInput">
                        ...
                        <table class="table-custom">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 15%;">Jumlah Server</th>
                            ...
                            <tbody id="tableBody">
                                <tr>
                                    ...
                                    <td><span class="badge-custom bg-primary">TI</span></td>
                                    <td><span class="badge-custom bg-success">12 Server</span></td>
                                    <td>
                                        <button class="btn-success-custom" onclick="editBidang(1)">
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>Bidang Humas dan Protokol</td>
                                    <td><span class="badge-custom bg-primary">HUMAS</span></td>
                                    <td><span class="badge-custom bg-success">8 Server</span></td>
                                    <td>
                                        <button class="btn-success-custom" onclick="editBidang(2)">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </button>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge-custom bg-primary">KEU</span></td>
                                    <td><span class="badge-custom bg-success">6 Server</span></td>
                                    <td>
                                        <button class="btn-success-custom" onclick="editBidang(3)">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </button>
                                ...
                                <tr>
                                    <td>4</td>
                                    <td>Bidang Umum dan Perlengkapan</td>
                                    <td><span class="badge-custom bg-primary">UMUM</span></td>
                                    <td><span class="badge-custom bg-success">4 Server</span></td>
                                    <td>
                                        <button class="btn-success-custom" onclick="editBidang(4)">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </button>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge-custom bg-primary">KEPEG</span></td>
                                    <td><span class="badge-custom bg-success">5 Server</span></td>
                                    <td>
                                        <button class="btn-success-custom" onclick="editBidang(5)">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header modal-header-custom">
                    <h5 class="modal-title"><i class="bi bi-plus-circle"></i> Tambah Bidang Baru</h5>
                ...
                <div class="modal-body">
                    <form id="formTambah">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Contoh: Bidang Teknologi Informasi" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Singkatan <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" placeholder="Contoh: TI" required>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn-primary-custom" onclick="simpanBidang()">
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header modal-header-custom">
                    <h5 class="modal-title"><i class="bi bi-pencil-square"></i> Edit Bidang</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form id="formEdit">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn-primary-custom" onclick="updateBidang()">
    ...
    <div class="modal fade" id="modalDelete" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn-danger-custom" onclick="hapusBidang()">
    ...
    <script>
        ...
        function editBidang(id) {
            ...
            document.getElementById('editNama').value = 'Bidang Teknologi Informasi';
            document.getElementById('editSingkatan').value = 'TI';
        ...
        function simpanBidang() {
            ...
            // Simulasi simpan - nanti diganti dengan AJAX
            showAlert('Data bidang berhasil ditambahkan!');
        ...
        function updateBidang() {
            ...
            showAlert('Data bidang berhasil diupdate!');
            bootstrap.Modal.getInstance(document.getElementById('modalEdit')).hide();
        }

        // Hapus bidang
        function hapusBidang() {
            showAlert('Data bidang berhasil dihapus!', 'danger');
